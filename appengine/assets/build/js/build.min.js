...
$(document).ready(function(){"use strict";var a=($("#select-platform"),$("#select-activity"),$("#select-microphone"),$("#select-lookingfor"),$("#select-level"),$("#select-dzlevel"),$("#select-search"),$("#aa-username")),e=$("#aa-platform"),n=$("#aa-activity"),o=$("#aa-microphone"),t=$("#aa-lookingfor"),l=$("#aa-level"),i=$("#aa-dzlevel"),r=$("#aa-description"),s=$("#save-agent"),u=($("search-agents"),'<i class="fa fa-plus-circle"></i> Agregar agente'),d='<i class="fa fa-spinner fa-spin"></i> Agregando, espera...',c=$("#add-alert-placement"),v=$("#modal-add-agent"),g=$("<div>").attr({"class":"alert alert-danger",role:"alert",style:"display:none"}).append($("<button>").attr({type:"button","class":"close","data-dismiss":"alert","aria-label":"close"}).append($("<span>").attr({"aria-hidden":"true"}).html("&times;"))),p="<strong>Oh no!</strong> El <u>nombre de usuario</u> es incorrecto. Verifícalo y vuelve a intentarlo.",h="<strong>Oh no!</strong> No has seleccionado <u>una plataforma</u>. Elige una y vuelve a intentarlo.",m="<strong>Oh no!</strong> No has seleccionado <u>una actividad</u>. Elige una y vuelve a intentarlo.",f="<strong>Oh no!</strong> No has indicado si <u>tienes o no un micrófono</u>. Elige una opción y vuelve a intentarlo.",y="<strong>Oh no!</strong> No has indicado <u>qué buscas en otros agentes</u>. Elige una opción y vuelve a intentarlo.",b="<strong>Oh no!</strong> No has indicado <u>qué nivel tienes en el modo historia</u>. Elige una opción y vuelve a intentarlo.",O="<strong>Oh no!</strong> No has indicado <u>qué nivel tienes en la Zona Oscura</u>. Elige una opción y vuelve a intentarlo.",E="<strong>Oh no!</strong> No has entregado <u>información adicional</u> como tu DPS o tu nivel de Salud. Escribe un detalle y vuelve a intentarlo.",N=function(a,e){v.scrollTop(0),a.empty().append(g.clone().append(e).fadeIn("fast"))},k=function(a,e){a.is(":disabled")?(a.prop("disabled",!1),a.html(a.attr("data-original")),a.attr("data-original","")):(a.prop("disabled",!0),a.attr("data-original",a.html()),a.html(e))};s.click(function(v){return k(s,d),""===$.trim(a.val())?(N(c,p),void k(s,u)):null==e.val()?(N(c,h),void k(s,u)):null==n.val()?(N(c,m),void k(s,u)):null==o.val()?(N(c,f),void k(s,u)):null==t.val()?(N(c,y),void k(s,u)):null==l.val()?(N(c,b),void k(s,u)):null==i.val()?(N(c,O),void k(s,u)):""===$.trim(r.val())?(N(c,E),void k(s,u)):void setTimeout(function(){k(s,u)},5e3)})});