...
$(document).ready(function(){"use strict";var a=($("#select-platform"),$("#select-activity"),$("#select-microphone"),$("#select-lookingfor"),$("#select-level"),$("#select-dzlevel"),$("#select-search"),$("#aa-username")),e=$("#aa-platform"),n=$("#aa-activity"),o=$("#aa-microphone"),t=$("#aa-lookingfor"),i=$("#aa-level"),l=$("#aa-dzlevel"),s=$("#aa-description"),r=$("#save-agent"),c=$("#search-agents"),u='<i class="fa fa-plus-circle"></i> Agregar agente',d='<i class="fa fa-spinner fa-spin"></i> Agregando, espera...',v='<i class="fa fa-search"></i> Buscar Agentes',g='<i class="fa fa-spinner fa-spin"></i> Buscando, espera...',p=$("#add-alert-placement"),f=$("#modal-add-agent"),m=$("<div>").attr({"class":"alert alert-danger",role:"alert",style:"display:none"}).append($("<button>").attr({type:"button","class":"close","data-dismiss":"alert","aria-label":"close"}).append($("<span>").attr({"aria-hidden":"true"}).html("&times;"))),h="<strong>Oh no!</strong> El <u>nombre de usuario</u> es incorrecto o es demasiado corto. Verifícalo y vuelve a intentarlo.",y="<strong>Oh no!</strong> No has seleccionado <u>una plataforma</u>. Elige una y vuelve a intentarlo.",b="<strong>Oh no!</strong> No has seleccionado <u>una actividad</u>. Elige una y vuelve a intentarlo.",O="<strong>Oh no!</strong> No has indicado si <u>tienes o no un micrófono</u>. Elige una opción y vuelve a intentarlo.",E="<strong>Oh no!</strong> No has indicado <u>qué buscas en otros agentes</u>. Elige una opción y vuelve a intentarlo.",N="<strong>Oh no!</strong> No has indicado <u>qué nivel tienes en el modo historia</u>. Elige una opción y vuelve a intentarlo.",k="<strong>Oh no!</strong> No has indicado <u>qué nivel tienes en la Zona Oscura</u>. Elige una opción y vuelve a intentarlo.",q="<strong>Oh no!</strong> No has entregado <u>información adicional</u> o escribiste poca información, como tu DPS o tu nivel de Salud. Escribe un detalle y vuelve a intentarlo.",A=function(a,e){f.scrollTop(0),a.empty().append(m.clone().append(e).fadeIn("fast"))},T=function(a,e){a.is(":disabled")?(a.prop("disabled",!1),a.html(a.attr("data-original")),a.attr("data-original","")):(a.prop("disabled",!0),a.attr("data-original",a.html()),a.html(e))};r.click(function(c){var v=function(a){A(p,a),T(r,u)};return T(r,d),""===$.trim(a.val())||$.trim(a.val()).length<6?void v(h):null==e.val()?void v(y):null==n.val()?void v(b):null==o.val()?void v(O):null==t.val()?void v(E):null==i.val()?void v(N):null==l.val()?void v(k):""===$.trim(s.val())||$.trim(s.val()).length<6?void v(q):void setTimeout(function(){T(r,u)},5e3)}),c.click(function(a){T(c,g),setTimeout(function(){T(c,v)},5e3)})});